package es.cursojava.hibernate.ejercicios.ejercicioEmpleadosRepaso.entities;
...
@Entity
@Table(name = "TB_EMPLEADO", uniqueConstraints = { @UniqueConstraint(name = "UK_EMPLEADO_NIF", columnNames = "NIF") })
